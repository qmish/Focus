...
### 3.2 Bots engine
- [ ] Реализовать реальную отправку сообщений ботом в комнаты.
- [ ] Реализовать команды `/create`, `/schedule`, `/status` c backend-интеграцией.
- [ ] Связать ботов с календарем Exchange и комнатами Jitsi.
- [ ] Добавить rate-limit и permission-check на bot-команды.

### Критерии готовности этапа 3
- [ ] Webhooks проходят полный цикл в обе стороны.
- [ ] Bot-команды выполняют реальные действия, а не заглушки.
- [ ] Ошибки webhook/bot наблюдаемы в админке и логах.
...
- [ ] Добавить раздел наблюдаемости webhook/bot ошибок.
